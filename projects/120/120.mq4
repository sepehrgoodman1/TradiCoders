...
//...
void CheckSignal(){
if(GetATR(1,sym)>ATR_Cross_Level && GetATR(2,sym)<ATR_Cross_Level || GetStoch(2,sym)<Stoch_OverSold_Level && GetStoch(1,sym)>Stoch_OverSold_Level){
        Trend = OP_BUY;
     }if(GetATR(1,sym)<ATR_Cross_Level && GetATR(2,sym)>ATR_Cross_Level || GetStoch(2,sym)>Stoch_OverBought_Level && GetStoch(1,sym)<Stoch_OverBought_Level){
        Trend = OP_SELL;
     }
}//+----------------------Local variable------------------------------+
