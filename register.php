...
<div>
    <div class="Wrapper BgRegister">
        ...
        <div class="RightSide">
            ...
            <!-- Start Forms -->
            <div>
                <div class="WrapperForms Mt100 M_Mt0 Mb100 H_Auto">
                    <div class="P_WrapperForms_Register">
                        <div class="LoginToTardi TitleFont">
                            ثبت نام
                        </div>
                        <form method="post" action="register_s.php">
                            <div id="body1">
                                <div class="P_TwoInput">
                                    ...
                                    <div class="P_Input_Two">
                                        <div>
                                            <label class="LabelInput">کد </label>
                                            <div class="PSendCode">
                                                <div class="Flex1">
                                                    <input
                                                            id="code_verify"
                                ...
                                <button type="button" onclick="OpenLink('googlelogin.php')"
                                        class="EnterWithGoogleBtn"><img src="assets/images/LogInGoogle.png"
                                                                        class="LogInWithGoogle"/> ورود با گوگل
                                </button>
                                <button type="button" onclick="OpenLink('githublogin.php')"
                                        class="EnterWithGoogleBtn"><img src="assets/images/Github.png"
                                                                        class="LogInWithGoogle"/> ورود با گیت هاب
                                </button>
                            </div>
                            <div style="display: none" id="body2">
                                <div class="P_TwoInput">
                                    <!-- Input -->
                                    <div class="P_Input_Two">
                                        <label class="LabelInput">نام</label>
                                        <input
                                                name="firstname"
                                                type="text"
                                                class="FormInput"
                                    ...
                                    <!-- Input -->
                                    <div class="P_Input_Two">
                                        <label class="LabelInput">نام خانوادگی</label>
                                        <input
                                                name="lastname"
                                                type="text"
                                                class="FormInput"
                                ...
                                <div>
                                    ...
                                    <button type="button" onclick="loginGoogle()" class="EnterWithGoogleBtn"><img
                                                src="assets/images/LogInGoogle.png" class="LogInWithGoogle"/> ورود با
                                        گوگل
                                    </button>
            ...
            xmlhttp.onreadystatechange = function () {
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    if (this.responseText > 0) {
                        document.getElementById('send_code_btn').innerText = "شماره تلفن تکراری";

                    } else {

                        document.getElementById('loading').style.display = "block";
                        document.getElementById('send_code_btn').style.display = "none";
                        var data2 = "mode=send_authentication&tmobile=" + phone+"&special=<?php echo $pagecontent[29]; ?>";
