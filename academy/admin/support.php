                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-left">
                            ...
                            <li class="breadcrumb-item active"><a href="support.php">پشتیبانی</a></li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="card">
                        <div class="card-header d-flex p-0">
                            <ul class="nav nav-pills ml-auto p-2">
                                <li class="nav-item"><a class="nav-link" href="#tab_1" data-toggle="tab">مدیریت تیکت</a></li>
                                <li class="nav-item"><a class="nav-link active show" href="#tab_2" data-toggle="tab">تیکت جدید</a></li>
                            </ul>
                        </div><!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <div class="tab-pane" id="tab_1">
                                    <div class="card-body table-responsive p-0">
                                        <table class="table table-hover">
                                            ...
                                            <tr style="text-align: center">
                                                <td><a href="programs/index.html"><button type="button" class="btn btn-block btn-primary">Primary</button></a></td>
                                                <td>
                                                    <div class="progress" style="margin-top: 10px;">
                                                        <div class="progress-bar" style="width: 70%">۷۰%</div>
                                                    </div>
                                                </td>
                                                <td>۱۱-۷-۲۰۱۴</td>
                                    ...
                                    <div class="card card-warning">
                                        ...
                                        <div class="card-body">
                                            <form role="form">
                                                ...
                                                <button style="width: 200px" type="submit" class="btn btn-block btn-success">ایجاد تیکت</button>
                                            </form>
                                        </div>
                                        <!-- /.card-body -->
                                    </div>
