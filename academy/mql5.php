...
<div class="row MainWrapper" style="margin: 0;margin-top:45px;">
    <div class="col-sm-3" style="height: 300px;">
        <div class="titles row">
            ...
            <a href="mql5.php" id="title-items" class="col-sm-4 active">MQL5</a>
            <a href="index.php" id="title-items" class="col-sm-4">MQL4</a>
        </div>
        <div class="title-content">

            <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for names.." class="InputSerachProg" title="Type in a name">

            <ul id="myUL">
                <?php
                $sql = "SELECT id, name, description,code,language, accesslevel FROM tc_Academy WHERE language='1002'";
                $result = $conn->query($sql);
    ...
    <div class="col-sm-9 LeftWrapper" style="border: 1px solid #d2d2d2;margin-top: 25px;padding: 20px;padding-top:0;text-align: right">
        <div class="left-box">
            <div id="code-box" style=";border: 1px solid #d2d2d2;width: 100%;margin: 5px;margin-right: 0;margin-bottom:20px;background: #f8f8f8">
                <div id="code-box-title">توابع کاربردی در متا ادیتور 5</div>
            ...
            <div id="code_box1">
                <div style="margin: 10px">
                    <h4 class="title">نام تابع: <span><?php echo $funcname;?></span></h4>
              ...
              ">ویرایش</button>
                ...
                {
                    ?>
                    <button type="button" class="BtnCopy" onclick="CopyToClipboard('textcopy');return false;" style="
                margin: 10px 0 10px 0;
                border-radius: 5px;
                float: left;
                color: white;
