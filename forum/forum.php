...
if (isset($_POST['question'])){
    if ($userid > -1){
        ...
        openLink('https://tradicoders.ir/login.php');
    }
}
...
<div>
    <div class="WrapperForums">
        <h1 class="TitleFont ForumText">انجمن</h1>
        <!-- Filters -->
        <div class="Filters">
            <div>
                ...
                <?php }else{ ?>
                    <a href="https://tradicoders.ir/login.php?url_redirect=https://forum.tradicoders.ir"><div class="SabtOrder">
                        <button >ورود</button>
                    </div></a>
                <?php } ?>
            </div>
        ...
        <div class="ForumArea">
            <div class="WrapperForumList Flex1">
                ...
                foreach ($sql_forum as $row) {
                    ...
                    ?>
                    <!-- ForumItem -->
                    <a href="<?php echo $question."__".$fid;?>"><div  class="ForumItem">
                        <div>
