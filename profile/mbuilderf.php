...
$pageName = 'مدیریت فانکشن ها';
$pageAddress = 'mbuilderf';
...
if (key_exists('trid2', $_POST)) {
    ...
    $exist = sizeof(selectQuery_tc_functions(" FCode='$FCode' and language='$trlang'"));
    $tblname = 'tc_functions';

    // update function
    if ($exist > 0) {
        if (updateQuery($tblname, "FHelp='$FHelp', FName='$FName', FValue='$FValue', FBody='$FBody', SBody='$SBody'", "FCode='$FCode' and language='$trlang'")){
    ...
    // set new function
        ...
        insertQuery($tblname, 'FCode, FHelp, FName, FValue, FBody, SBody, language', "'$FCode', '$FHelp', '$FName', '$FValue','$FBody', '$SBody', '$trlang'");
        alert("فانکشن جدید اضافه شد");
    }
    // ./set new function
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                ...
                                <form action="" method="post">
                                    <div class="row">
                                        <div class="col-4">
                                            <input type="text" class="form-control" name="trid" placeholder="کد فانکشن">
                                        </div>
                                        <div class="col-4">
                            ...
                            <div class="card-body row">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tr style="text-align: center">
                                        <th scope="col">شماره فانکشن</th>
                                        <th scope="col">نام فانکشن</th>
                                        <th scope="col">زبان فانکشن</th>
                                    ...
                                    <?php
                                    // get functions
                                    $sql = selectQuery_tc_functions("", "FCode, FName, language");
                                    foreach ($sql as $row) {
                                        $trid = $row['FCode'];
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="" method="post">
                                        ...
                                        <?php
                                        $sql = selectQuery_tc_functions(" FCode='$trid' and language='$trlang'");
                                        $row = $sql[0];
                                        ?>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">بدنه
                                                فانکشن</label>
                                            <textarea class="form-control" name="FBody"
                                                      rows="4"><?php echo $row['FBody']; ?></textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">بدنه
                                                ستینگ</label>
                                            <textarea class="form-control" name="SBody"
                                                      rows="4"><?php echo $row['SBody']; ?></textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label for="exampleFormControlTextarea1" class="form-label">توضیحات
                                                فانکشن</label>
                                            <textarea class="form-control" name="FHelp"
                                                      rows="4"><?php echo $row['FHelp']; ?></textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label for="exampleFormControlTextarea1" class="form-label">قیمت
                                                فانکشن</label>
                                            <input class="form-control" type="text" name="FValue"
                                                   value="<?php echo $row['FValue']; ?>">
                                        </div>
