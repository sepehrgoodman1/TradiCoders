...
if (permissionPageInside($pageAddress) || $role == 'admin') {
                        ...
                        <div class="col-sm-6">
                            <div class="">
                                <ol class="breadcrumb float-sm-left">
                                    ...
                                    <li class="breadcrumb-item active"><a href="<?php echo $pageAddress ?>.php"><?php echo $pageName ?></a>
                                    </li>
                                </ol>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
    ...
    echo "<script>window.open('https://www.tradicoders.ir/profile/index.php', '_self');</script>";
}
?>