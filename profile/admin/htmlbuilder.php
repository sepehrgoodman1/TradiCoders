...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["sabt"]) || isset($_POST["edit"]))
    {
        echo "sabt";
            ...
            <div class='page-content single_content'>
                <div class='col-md-9'>
                    <div class='content_bx'>
                        <img src='../".$authorurl."' alt='' style='width: 100px;'>
                        <div class='meta'>
                            <span><i class='fa fa-eye'>".$articleViewnum."</i></span>
                            <span class='post_tags'><i class='fa fa-archive'></i>".$tags1.$tags2.$tags3.$tags4.$tags5.$tags6."</span>
                        </div>
                        <h1>".$subject."</h1><hr>
                        <div class='p_text'>
                            ".$cbody."
                ...
                <div class='col-md-3'>
                    <div class='side_bx'>
                        ...
                        <ul>
                            ". $Latestcontent1.$Latestcontent2.$Latestcontent3.$Latestcontent4."
                        </ul>
                    </div>
                    <div class='side_bx' style='display:none;'>
